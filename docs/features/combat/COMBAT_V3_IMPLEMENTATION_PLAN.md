...
3. **Gate:** visual diff against the retained native implementation and captured design record on 390×844 iPhone 15 Pro simulator.
...
- [x] User reviewed + approved the historical B2-v3 direction (captured here; raw prototype file was later removed during repository cleanup)
