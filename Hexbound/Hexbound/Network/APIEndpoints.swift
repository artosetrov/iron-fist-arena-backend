...
enum APIEndpoints {
    ...
    // Interactive Combat v1 — feature-flagged on server (INTERACTIVE_COMBAT_V1)
    static let pvpMatchStart = "/api/pvp/match/start"
    static let pvpStrike = "/api/pvp/strike"
    static let pvpMatchComplete = "/api/pvp/match/complete"
    ...
    static let shopContraband = "/api/shop/contraband"
    ...
    static let passivesActiveSlotsBatch = "/api/passives/active-slots/batch"
    static let passivesActiveSlotsUnlockPremium = "/api/passives/active-slots/unlock-premium"
