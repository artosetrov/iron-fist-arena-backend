...
struct BossInfo: Identifiable, Hashable {
    ...
    var emoji: String {
        switch id {
        case 1: return "swords"
        case 2: return "gearshape.fill"
        case 3: return "ant.fill"
        case 4: return "skull.fill"
        case 5: return "flame.fill"
        case 6: return "sparkles"
        case 7: return "snake.fill"
        case 8: return "figure.strengthtraining.traditional"
        case 9: return "skull.fill"
...
struct DungeonInfo: Identifiable {
    ...
    static func from(serverData d: [String: Any]) -> DungeonInfo? {
        ...
        let rewardIcons: [String] = {
            var icons = ["coloncurrencysign.circle.fill"]  // Gold always present
    ...
    /// Map item type string to an SF Symbol icon
    ...
    static let trainingCamp = DungeonInfo(
        ...
        bosses: [
            ...
            BossInfo(id: 10, name: "Arena Warden", level: 10, hp: 1000,
                     ...
                     loot: [
                        LootPreview(icon: "coloncurrencysign.circle.fill", name: "Gold", detail: "200–350", imageKey: "loot-gold"),
                        LootPreview(icon: "sword", name: "Warden's Blade", detail: "Epic (8%)", imageKey: "loot-wardens-blade", rarity: .epic),
                        LootPreview(icon: "diamond.fill", name: "Gems", detail: "5–10", imageKey: "loot-gems"),
                     ]),
        ],
        themeColor: DarkFantasyTheme.glowArena,
        rewardIcons: ["coloncurrencysign.circle.fill", "sword", "scroll.fill", "diamond.fill"]
    )
    ...
    static let desecratedCatacombs = DungeonInfo(
        ...
        bosses: [
            BossInfo(id: 1, name: "Tomb Rat King", level: 10, hp: 600,
                     ...
                     loot: [
                        LootPreview(icon: "coloncurrencysign.circle.fill", name: "Gold", detail: "150–250", imageKey: "loot-gold"),
                        LootPreview(icon: "star.fill", name: "XP", detail: "40–60", imageKey: "loot-xp"),
                     ]),
            BossInfo(id: 2, name: "Crypt Walker", level: 11, hp: 700,
                     ...
                     loot: [
                        LootPreview(icon: "coloncurrencysign.circle.fill", name: "Gold", detail: "160–270", imageKey: "loot-gold"),
                        LootPreview(icon: "sword", name: "Crypt Sword", detail: "Uncommon", imageKey: "loot-crypt-sword", rarity: .uncommon),
                     ]),
            BossInfo(id: 3, name: "Ghoul Brute", level: 12, hp: 800,
                     ...
                     loot: [
                        LootPreview(icon: "coloncurrencysign.circle.fill", name: "Gold", detail: "180–300", imageKey: "loot-gold"),
                        LootPreview(icon: "shield.fill", name: "Ghoul Hide", detail: "Rare (15%)", imageKey: "loot-ghoul-hide", rarity: .rare, itemTypeRaw: "chest"),
                     ]),
            BossInfo(id: 4, name: "Banshee", level: 13, hp: 880,
                     ...
                     loot: [
                        LootPreview(icon: "coloncurrencysign.circle.fill", name: "Gold", detail: "200–320", imageKey: "loot-gold"),
                        LootPreview(icon: "scroll.fill", name: "Wail Scroll", detail: "10%", imageKey: "loot-wail-scroll", rarity: .uncommon, itemTypeRaw: "consumable"),
                     ]),
            BossInfo(id: 5, name: "Skeleton Knight", level: 14, hp: 950,
                     ...
                     loot: [
                        LootPreview(icon: "coloncurrencysign.circle.fill", name: "Gold", detail: "220–350", imageKey: "loot-gold"),
                        LootPreview(icon: "sword", name: "Knight's Edge", detail: "Rare (12%)", imageKey: "loot-knights-edge", rarity: .rare),
                     ]),
            BossInfo(id: 6, name: "Corpse Weaver", level: 15, hp: 1050,
                     ...
                     loot: [
                        LootPreview(icon: "coloncurrencysign.circle.fill", name: "Gold", detail: "250–380", imageKey: "loot-gold"),
                        LootPreview(icon: "flask.fill", name: "Death Thread", detail: "Rare (8%)", imageKey: "loot-death-thread", rarity: .rare, itemTypeRaw: "consumable"),
                     ]),
            BossInfo(id: 7, name: "Wraith Assassin", level: 16, hp: 1150,
                     ...
                     loot: [
                        LootPreview(icon: "coloncurrencysign.circle.fill", name: "Gold", detail: "270–400", imageKey: "loot-gold"),
                        LootPreview(icon: "sword", name: "Wraith Blade", detail: "Epic (5%)", imageKey: "loot-wraith-blade", rarity: .epic),
                     ]),
            BossInfo(id: 8, name: "Bone Colossus", level: 17, hp: 1300,
                     ...
                     loot: [
                        LootPreview(icon: "coloncurrencysign.circle.fill", name: "Gold", detail: "300–450", imageKey: "loot-gold"),
                        LootPreview(icon: "shield.fill", name: "Bone Armor", detail: "Epic (5%)", imageKey: "loot-bone-armor", rarity: .epic, itemTypeRaw: "chest"),
                     ]),
            BossInfo(id: 9, name: "Necro Priest", level: 18, hp: 1450,
                     ...
                     loot: [
                        LootPreview(icon: "coloncurrencysign.circle.fill", name: "Gold", detail: "350–500", imageKey: "loot-gold"),
                        LootPreview(icon: "scroll.fill", name: "Necrotic Tome", detail: "Epic (4%)", imageKey: "loot-necrotic-tome", rarity: .epic, itemTypeRaw: "consumable"),
                     ]),
            BossInfo(id: 10, name: "Lich King Verath", level: 20, hp: 1800,
                     ...
                     loot: [
                        LootPreview(icon: "coloncurrencysign.circle.fill", name: "Gold", detail: "500–800", imageKey: "loot-gold"),
                        LootPreview(icon: "sword", name: "Lich Scythe", detail: "Legendary (3%)", imageKey: "loot-lich-scythe", rarity: .legendary),
                        LootPreview(icon: "diamond.fill", name: "Gems", detail: "10–20", imageKey: "loot-gems"),
                     ]),
        ],
        themeColor: DarkFantasyTheme.glowMystic,
        rewardIcons: ["coloncurrencysign.circle.fill", "sword", "shield.fill", "diamond.fill"]
    )
    ...
    static let volcanicForge = DungeonInfo(
        ...
        bosses: [
            BossInfo(id: 1, name: "Lava Crawler", level: 20, hp: 1000,
                     ...
                     loot: [
                        LootPreview(icon: "coloncurrencysign.circle.fill", name: "Gold", detail: "300–500", imageKey: "loot-gold"),
                        LootPreview(icon: "star.fill", name: "XP", detail: "80–120", imageKey: "loot-xp"),
                     ]),
            BossInfo(id: 2, name: "Ember Sprite", level: 21, hp: 1100,
                     ...
                     loot: [
                        LootPreview(icon: "coloncurrencysign.circle.fill", name: "Gold", detail: "320–530", imageKey: "loot-gold"),
                        LootPreview(icon: "scroll.fill", name: "Ember Rune", detail: "Uncommon", imageKey: "loot-ember-rune", rarity: .uncommon, itemTypeRaw: "consumable"),
                     ]),
            BossInfo(id: 3, name: "Slag Brute", level: 22, hp: 1250,
                     ...
                     loot: [
                        LootPreview(icon: "coloncurrencysign.circle.fill", name: "Gold", detail: "350–560", imageKey: "loot-gold"),
                        LootPreview(icon: "shield.fill", name: "Slag Plate", detail: "Rare (15%)", imageKey: "loot-slag-plate", rarity: .rare, itemTypeRaw: "chest"),
                     ]),
            BossInfo(id: 4, name: "Flame Hound", level: 23, hp: 1350,
                     ...
                     loot: [
                        LootPreview(icon: "coloncurrencysign.circle.fill", name: "Gold", detail: "380–600", imageKey: "loot-gold"),
                        LootPreview(icon: "sword", name: "Hound Fang", detail: "Rare (12%)", imageKey: "loot-hound-fang", rarity: .rare),
                     ]),
            BossInfo(id: 5, name: "Molten Shaman", level: 24, hp: 1500,
                     ...
                     loot: [
                        LootPreview(icon: "coloncurrencysign.circle.fill", name: "Gold", detail: "400–650", imageKey: "loot-gold"),
                        LootPreview(icon: "scroll.fill", name: "Lava Burst Scroll", detail: "10%", imageKey: "loot-lava-scroll", rarity: .uncommon, itemTypeRaw: "consumable"),
                     ]),
            BossInfo(id: 6, name: "Obsidian Knight", level: 25, hp: 1650,
                     ...
                     loot: [
                        LootPreview(icon: "coloncurrencysign.circle.fill", name: "Gold", detail: "450–700", imageKey: "loot-gold"),
                        LootPreview(icon: "sword", name: "Obsidian Blade", detail: "Epic (5%)", imageKey: "loot-obsidian-blade", rarity: .epic),
                     ]),
            BossInfo(id: 7, name: "Furnace Worm", level: 26, hp: 1800,
                     ...
                     loot: [
                        LootPreview(icon: "coloncurrencysign.circle.fill", name: "Gold", detail: "480–750", imageKey: "loot-gold"),
                        LootPreview(icon: "flask.fill", name: "Magma Core", detail: "Epic (5%)", imageKey: "loot-magma-core", rarity: .epic, itemTypeRaw: "consumable"),
                     ]),
            BossInfo(id: 8, name: "Cinderlord", level: 27, hp: 2000,
                     ...
                     loot: [
                        LootPreview(icon: "coloncurrencysign.circle.fill", name: "Gold", detail: "500–800", imageKey: "loot-gold"),
                        LootPreview(icon: "shield.fill", name: "Cinder Mail", detail: "Epic (4%)", imageKey: "loot-cinder-mail", rarity: .epic, itemTypeRaw: "chest"),
                     ]),
            BossInfo(id: 9, name: "Magma Titan", level: 28, hp: 2300,
                     ...
                     loot: [
                        LootPreview(icon: "coloncurrencysign.circle.fill", name: "Gold", detail: "550–900", imageKey: "loot-gold"),
                        LootPreview(icon: "sword", name: "Titan Hammer", detail: "Epic (3%)", imageKey: "loot-titan-hammer", rarity: .epic),
                     ]),
            BossInfo(id: 10, name: "Pyrox the Eternal", level: 30, hp: 3000,
                     ...
                     loot: [
                        LootPreview(icon: "coloncurrencysign.circle.fill", name: "Gold", detail: "800–1200", imageKey: "loot-gold"),
                        LootPreview(icon: "sword", name: "Pyrox Greatsword", detail: "Legendary (2%)", imageKey: "loot-pyrox-greatsword", rarity: .legendary),
                        LootPreview(icon: "diamond.fill", name: "Gems", detail: "15–30", imageKey: "loot-gems"),
                     ]),
        ],
