...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    createBattleResultMail(prisma, {
      ...
      winnerAvatar: attackerWon ? attacker.avatar : defender.avatar,
      loserAvatar: attackerWon ? defender.avatar : attacker.avatar,
      winnerClass: attackerWon ? attacker.class : defender.class,
      loserClass: attackerWon ? defender.class : attacker.class,
