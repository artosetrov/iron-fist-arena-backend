...
async function main() {
  ...
  const ITEMS: ItemDef[] = [
    ...
    { catalogId: 'stamina_potion_small', itemName: 'Small Stamina Potion', itemType: 'consumable', rarity: 'common', itemLevel: 1, buyPrice: 100, sellPrice: 25, baseStats: {}, description: 'Restores 30 stamina.', specialEffect: '+30 stamina', dropChance: 0, imageKey: 'pot_stamina_small' },
    { catalogId: 'stamina_potion_medium', itemName: 'Medium Stamina Potion', itemType: 'consumable', rarity: 'uncommon', itemLevel: 1, buyPrice: 250, sellPrice: 63, baseStats: {}, description: 'Restores 60 stamina.', specialEffect: '+60 stamina', dropChance: 0, imageKey: 'pot_stamina_medium' },
    { catalogId: 'stamina_potion_large', itemName: 'Large Stamina Potion', itemType: 'consumable', rarity: 'rare', itemLevel: 1, buyPrice: 500, sellPrice: 125, baseStats: {}, description: 'Fully restores stamina to maximum.', specialEffect: 'Full stamina restore', dropChance: 0, imageKey: 'pot_stamina_large' },
