...
VALUES
  ...
  (gen_random_uuid(), 'warrior.found.vitality',     'Vitality',     '+3%/+6%/+9% Max HP',                      'percent_hp'::"PassiveBonusType",         NULL,  3, 1,  120, 520, 6, 'warrior'::"CharacterClass", TRUE, TRUE, FALSE, NULL, NULL, NULL),
  (gen_random_uuid(), 'warrior.found.iron_skin',    'Iron Skin',    '+2/+4/+6 Armor',                          'flat_armor'::"PassiveBonusType",         NULL,  2, 1,  300, 520, 6, 'warrior'::"CharacterClass", TRUE, TRUE, FALSE, NULL, NULL, NULL),
  (gen_random_uuid(), 'warrior.found.wards',        'Wards',        '+2/+4/+6 Magic Resist',                   'flat_magic_resist'::"PassiveBonusType",  NULL,  2, 1,  480, 520, 6, 'warrior'::"CharacterClass", TRUE, TRUE, FALSE, NULL, NULL, NULL),
  (gen_random_uuid(), 'warrior.found.critical_eye', 'Critical Eye', '+1%/+2%/+3% Critical Strike Chance',      'flat_crit_chance'::"PassiveBonusType",   NULL,  1, 1,  680, 520, 6, 'warrior'::"CharacterClass", TRUE, TRUE, FALSE, NULL, NULL, NULL),
  (gen_random_uuid(), 'warrior.found.swift_resolve','Swift Resolve','+3%/+6%/+9% Damage',                      'percent_damage'::"PassiveBonusType",     NULL,  3, 1,  880, 520, 6, 'warrior'::"CharacterClass", TRUE, TRUE, FALSE, NULL, NULL, NULL), -- PROXY: attack speed
  (gen_random_uuid(), 'warrior.found.lifesteal',    'Lifesteal',    '+2%/+4%/+6% Life Steal',                  'lifesteal'::"PassiveBonusType",          NULL,  2, 1, 1080, 520, 6, 'warrior'::"CharacterClass", TRUE, TRUE, FALSE, NULL, NULL, NULL),

  -- Berserker lane (offense, tier 2, x~220→300) ----------------------------
  (gen_random_uuid(), 'warrior.berserk.rage',       'Rage',         '+4%/+8%/+12% Damage',                     'percent_damage'::"PassiveBonusType",     NULL,  4, 2,  220, 400, 6, 'warrior'::"CharacterClass", FALSE, TRUE, FALSE, NULL, NULL, NULL),
  (gen_random_uuid(), 'warrior.berserk.momentum',   'Momentum',     '+3%/+6%/+9% Critical Strike Chance',      'flat_crit_chance'::"PassiveBonusType",   NULL,  3, 2,  220, 290, 6, 'warrior'::"CharacterClass", FALSE, TRUE, FALSE, NULL, NULL, NULL), -- PROXY: crit-after-kill (30s)
  (gen_random_uuid(), 'warrior.berserk.bloodlust',  'Bloodlust',    '+4%/+8%/+12% Life Steal',                 'lifesteal'::"PassiveBonusType",          NULL,  4, 2,  300, 180, 6, 'warrior'::"CharacterClass", FALSE, TRUE, FALSE, NULL, NULL, NULL), -- PROXY: only below 50% HP

  -- Crusader lane — primary (balance, tier 2, x=430) -----------------------
  (gen_random_uuid(), 'warrior.crus.iron_will',     'Iron Will',    '+3%/+6%/+9% Magic Resist',                'percent_magic_resist'::"PassiveBonusType", NULL,  3, 2,  430, 400, 6, 'warrior'::"CharacterClass", FALSE, TRUE, FALSE, NULL, NULL, NULL), -- PROXY: "all resists" → magic resist only
  (gen_random_uuid(), 'warrior.crus.retribution',   'Retribution',  '+3%/+6%/+9% Damage Reduction',            'damage_reduction'::"PassiveBonusType",   NULL,  3, 2,  430, 290, 6, 'warrior'::"CharacterClass", FALSE, TRUE, FALSE, NULL, NULL, NULL), -- PROXY: reflect melee
  (gen_random_uuid(), 'warrior.crus.sanctified',    'Sanctified',   '+10%/+20%/+30% Life Steal',               'lifesteal'::"PassiveBonusType",          NULL, 10, 2,  520, 180, 6, 'warrior'::"CharacterClass", FALSE, TRUE, FALSE, NULL, NULL, NULL), -- PROXY: heal on block

  -- Crusader lane — mirror (balance, tier 2, x=600) ------------------------
  (gen_random_uuid(), 'warrior.crus.fortitude',     'Fortitude',    '+5%/+10%/+15% Max HP',                    'percent_hp'::"PassiveBonusType",         NULL,  5, 2,  600, 400, 6, 'warrior'::"CharacterClass", FALSE, TRUE, FALSE, NULL, NULL, NULL),
  (gen_random_uuid(), 'warrior.crus.second_wind',   'Second Wind',  '+10%/+20%/+30% Max HP (threshold heal)',  'percent_hp'::"PassiveBonusType",         NULL, 10, 2,  600, 290, 6, 'warrior'::"CharacterClass", FALSE, TRUE, FALSE, NULL, NULL, NULL), -- PROXY: threshold heal at 25% HP
  (gen_random_uuid(), 'warrior.crus.aegis',         'Aegis',        '+5%/+10%/+15% Damage Reduction',          'damage_reduction'::"PassiveBonusType",   NULL,  5, 2,  680, 180, 6, 'warrior'::"CharacterClass", FALSE, TRUE, FALSE, NULL, NULL, NULL), -- PROXY: only below 30% HP

  -- Executioner lane (defense grid / theme=finishers, tier 2, x~830→800) ---
  (gen_random_uuid(), 'warrior.exec.ruthless',      'Ruthless',     '+5%/+10%/+15% Damage',                    'percent_damage'::"PassiveBonusType",     NULL,  5, 2,  830, 400, 6, 'warrior'::"CharacterClass", FALSE, TRUE, FALSE, NULL, NULL, NULL), -- PROXY: crit damage
  (gen_random_uuid(), 'warrior.exec.execute',       'Execute',      '+10%/+20%/+30% Damage',                   'percent_damage'::"PassiveBonusType",     NULL, 10, 2,  830, 290, 6, 'warrior'::"CharacterClass", FALSE, TRUE, FALSE, NULL, NULL, NULL), -- PROXY: vs enemies < 30% HP
  (gen_random_uuid(), 'warrior.exec.decapitate',    'Decapitate',   '+5%/+10%/+15% Cooldown Reduction',        'cooldown_reduction'::"PassiveBonusType", NULL,  5, 2,  800, 180, 6, 'warrior'::"CharacterClass", FALSE, TRUE, FALSE, NULL, NULL, NULL), -- PROXY: skip enemy turn on kill

  -- Keystones (tier 3, single-rank, cost 3) --------------------------------
  (gen_random_uuid(), 'warrior.key.frenzy',         'Frenzy',       '+7% Damage (Chance of extra strike)',     'percent_damage'::"PassiveBonusType",     NULL,  7, 3,  300,  80, 3, 'warrior'::"CharacterClass", FALSE, TRUE, FALSE, NULL, NULL, NULL), -- PROXY: 15% extra-strike @ 50% dmg
  (gen_random_uuid(), 'warrior.key.bulwark',        'Bulwark',      '+10% Damage Reduction (while >80% HP)',   'damage_reduction'::"PassiveBonusType",   NULL, 10, 3,  600,  80, 3, 'warrior'::"CharacterClass", FALSE, TRUE, FALSE, NULL, NULL, NULL),
  (gen_random_uuid(), 'warrior.key.headsman',       'Headsman',     '+15% Damage (crits on <40% HP)',          'percent_damage'::"PassiveBonusType",     NULL, 15, 3,  800,  80, 3, 'warrior'::"CharacterClass", FALSE, TRUE, FALSE, NULL, NULL, NULL), -- PROXY: 1.8× crit vs low HP

  -- Ultimates (tier 4, single-rank, cost 5, isActivatable) ------------------
  (gen_random_uuid(), 'warrior.ult.unleash',        'Unleash the Beast', '+25% Damage (also +10% damage taken). Active: Rampage.', 'percent_damage'::"PassiveBonusType", NULL, 25, 4, 450, 20, 5, 'warrior'::"CharacterClass", FALSE, TRUE, TRUE,  'burst_damage'::"TalentSlotAction",     90, 60),
  (gen_random_uuid(), 'warrior.ult.champion',       'Champion''s Resolve','+20% Armor. Active: Guardian Oath.',               'percent_armor'::"PassiveBonusType",  NULL, 20, 4, 750, 20, 5, 'warrior'::"CharacterClass", FALSE, TRUE, TRUE,  'shield_self'::"TalentSlotAction",      75, 50);
