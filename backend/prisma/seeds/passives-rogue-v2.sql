...
VALUES
  ...
  (gen_random_uuid(), 'rogue.found.cunning',    'Cunning',    '+3%/+6%/+9% Damage',                        'percent_damage'::"PassiveBonusType",     NULL,  3, 1, 400, 0, 6, 'rogue'::"CharacterClass", TRUE, FALSE, FALSE, NULL, NULL, NULL), -- PROXY: initiative
